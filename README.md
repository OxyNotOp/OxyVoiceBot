...
<p align="center">
  <img src="https://telegra.ph/file/03f01d061f5d29e4d3830.jpg">
</p>
...
License -> https://github.com/OxyNotOp/OxyVoiceBot/blob/master/LICENSE

```

## Deploy to Heroku

[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/OxyNotOp/OxyVoiceBot)

NOTE: Make sure you have started a VoiceChat in your Group before deploying.
### Deploy to VPS

```sh
git clone https://github.com/OxyNotOp/OxyVoiceBot
cd OxyVoiceBot
...
Connect Me On [Telegram](https://t.me/FallenAngel_xD)
